class ui {
    ...
    showProfile(user) {
        ...
        <div class="card card-body mb-3">
            <div class="row">
                <div class="col-md-3">
                    <img scr="${user.avatar_url}" class="img-fluid mb-2">
                    <a href="${user.html_url}" target="_blank" class="bth
                        btn-primary btn-block mb-4">View Profile</a>
                </div>
                <div class="card card-body col-mb-9>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Member Since: ${user.created_id}></li>
                    </ul>
                </div>
            </div>
        </div>
